...
class DailiController extends IndexController
{
    public function index()
    {
        ...
        $data = M('daili')->where($where)->fetchSql(false)
    ...
    public function content($id){
        $data = M('daili')->fetchSql(false)->find($id);
    ...
    */
    public function delete()
    {
        ...
        if ($model->delete(I('get.id', 0)) !== FALSE) {
            ...
            $this->success('删除成功！', U('Daili/index'));
            exit;
        } else {
