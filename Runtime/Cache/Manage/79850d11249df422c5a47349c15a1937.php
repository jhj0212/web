    ...
    <form action="<?php echo U('edit');?>" method='post' class="form-x" enctype="multipart/form-data">
        ...
        <div class="body-content">
            ...
            <div class="form-group">
                ...
                <div class="field">
                    <?php if($data["pid"] == 1): ?><input  class="input"  style="width: 60%;" name="condition" value="公司简介" disabled="disabled"/><?php endif; ?>
                    <?php if($data["pid"] == 2): ?><input  class="input"  style="width: 60%;" name="condition" value="企业文化" disabled="disabled"/><?php endif; ?>
                    <?php if($data["pid"] == 3): ?><input  class="input"  style="width: 60%;" name="condition" value="行业资质" disabled="disabled"/><?php endif; ?>
                </div>
            </div>
            <!--<?php if($data["pic"] != null): ?><div class="form-group" id="pp">
                    <div class="label">
                        <label>图片：</label>
                    </div>
                    <div class="field">
