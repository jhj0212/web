...
<body>
<form method="post" action="<?php echo U('Privilege/index');?>" id="listform">
    <div class="panel admin-panel">
        ...
        <div class="padding border-bottom">
            <ul class="search" style="padding-left:10px;">
                <li> <a class="button border-main icon-plus-square-o" href="<?php echo U('addPri');?>"> 添加权限</a> </li>
                <li>
            ...
            <?php if(is_array($person)): foreach($person as $key=>$data): ?><tr>
                    ...
                    <td>
                        <div class="button-group">
                            ...
                            <a class="button  border-red" href="<?php echo U('delUser', array('id' => $data['id']));?>" onclick="return confirm('确定要删除吗？');">
