    ...
    <div class="panel admin-panel">
        ...
        <!--<div class="padding border-bottom">
            <ul class="search" style="padding-left:10px;">
                <li>
                    <input type="text" placeholder="请输入搜索姓名" id="keywords" name="keywords" class="input" style="width:250px; line-height:17px;display:inline-block" />
        ...
        <table class="table table-hover text-center">
            ...
            <?php if(is_array($data)): foreach($data as $key=>$data): ?><tr>
                    ...
                    <td width=""><?php echo ($data["name"]); ?></td>
