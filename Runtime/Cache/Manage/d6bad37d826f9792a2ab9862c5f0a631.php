    ...
    <form action="<?php echo U('edit');?>" method='post' class="form-x" enctype="multipart/form-data">
        ...
        <div class="body-content">
            ...
            <div class="form-group">
                ...
                <div class="field">
                    <label style="line-height:33px;">
                        <input size="50" class="input" type="text" style="width: 60%;" name='price' id="price" value="<?php echo $data['price']; ?>"/>
            ...
            <div class="form-group">
                ...
                <div class="field">
                    <label>
                        <textarea name="content" style="resize: none;width: 60%;height: 100px;" maxlength="150"><?php echo ($data["content"]); ?></textarea>
                    </label>
                </div>
            </div>
