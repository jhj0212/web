    ...
    <form action="<?php echo U('edit');?>" method='post' class="form-x" enctype="multipart/form-data">
        ...
        <div class="body-content">
            ...
            <div class="form-group">
                ...
                <div class="field">
                    <?php if($data["pid"] == 1): ?><input  class="input"  style="width: 60%;" name="condition" value="小规模企业优惠政策" disabled="disabled"/><?php endif; ?>
                    <?php if($data["pid"] == 2): ?><input  class="input"  style="width: 60%;" name="condition" value="新税法动态" disabled="disabled"/><?php endif; ?>
                </div>
            </div>
            <?php if($data["url"] != null): ?><div class="form-group" id="pp">
                    <div class="label">
                        <label>图片：</label>
                    </div>
                    <div class="field">
                        <img src="/web/Public<?php echo ($data["url"]); ?>" style="height: 100px;width: 150px;">
