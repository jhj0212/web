...
<div class="panel admin-panel">
    ...
    <form action="<?php echo U('addVideo');?>" id="imageform" method='post' class="form-x" enctype="multipart/form-data">
        <div class="body-content">
            ...
            <div class="form-group">
                ...
                <div class="field">
                    <input type="text" class="input" style="width: 60%;" value="" name="url" data-validate="required:请输入视频地址" />
                    <div class="tips"></div>
                </div>
            </div>
            <div class="form-group">
