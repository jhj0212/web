...
<html>
	...
	<head>
		...
		<link rel="stylesheet" type="text/css" href="/RCweb/Public/Home/css/liebiao.css" />
		...
		<div class="main">
			<div class="main_nr">
				<div class="zht_s clearfix">
					<div class="xbt">
						<!--<img src="img/yaowen.png" />-->
						<h2><?php echo ($res[0]["type"]); ?></h2>
					</div>
				</div>
				<div class="zht_z">
					<div class="nr">
						<ul>
							<?php if(is_array($res)): foreach($res as $key=>$vo): ?><li class="clearfix">
									<!--<span></span>-->
									<a href="<?php echo U('info',array('id'=>$vo['id']));?>"><?php echo ($vo["title"]); ?></a>
									<em class="fr"><?php echo (date("Y-m-d",$vo["time"])); ?></em>
