...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="/RCweb/Public/Home/css/chanpin.css" />
		...
		<div class="fenlei">
			<div class="fenlei_s">
				...
				<div class="city_listLeft">
					<ul>
						<?php if(is_array($chanpin)): foreach($chanpin as $key=>$vo): ?><li>
								<div class="city_listdet">
									<img src="/RCweb/Public/Home/img/c_<?php echo ($vo["id"]); ?>.png">
									<span>
										<a href="
											<?php if($vo["id"] == 1): echo U('Zhaopin/zhuce'); endif; ?>
											<?php if($vo["id"] == 2): echo U('Zhaopin/daili'); endif; ?>
											<?php if($vo["id"] != 1): if($vo["id"] != 2): echo U('info',array('id'=>$vo['id'])); endif; endif; ?>
										"><?php echo ($vo["title"]); ?></a>
									</span>
									<dl class="w_sales clearFix"></dl>
									<h3><?php echo ($vo["introduce"]); ?></h3>
								</div>
								<a href="
									<?php if($vo["id"] == 1): echo U('Zhaopin/zhuce'); endif; ?>
									<?php if($vo["id"] == 2): echo U('Zhaopin/daili'); endif; ?>
