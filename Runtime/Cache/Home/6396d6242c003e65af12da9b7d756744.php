...
<html>
	...
	<head>
		...
		<link rel="stylesheet" type="text/css" href="/RCweb/Public/Home/css/daili.css" />
	...
	<body class="zhuti">
		...
		<!--<?php if(is_array($data)): foreach($data as $key=>$vo): ?><div class="neirong">
				<h3><a href="<?php echo U('dailiInfo',array('id'=>$vo['id']));?>"><?php echo ($vo["title"]); echo ($vo["price"]); ?>元/起</a></h3>
		...
		<div class="fenlei">
			<div class="fenlei_s">
				<!--<p>第一类：代办类</p>-->
				<!--<div class="city_list">-->
				<div class="city_listLeft">
					<ul>
						<?php if(is_array($data)): foreach($data as $key=>$vo): ?><li>
								<div class="city_listdet">
									<img src="/RCweb/Public/Home/img/d_<?php echo ($vo['id']); ?>.png">
									<span>
										<a href="<?php echo U('dailiInfo',array('id'=>$vo['id']));?>"><?php echo ($vo["title"]); ?></a>
									</span>
									<dl class="w_sales clearFix"></dl>
								...
								<em><?php echo ($vo["price"]); ?><strike>元/起</strike></em>
								<a href="<?php echo U('dailiInfo',array('id'=>$vo['id']));?>"><h4>了解详情</h4></a>
