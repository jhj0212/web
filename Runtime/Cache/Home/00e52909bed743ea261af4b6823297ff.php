...
<html>
	...
	<head>
		...
		<link rel="stylesheet" type="text/css" href="/RCweb/Public/Home/css/index.css" />
		<link rel="stylesheet" type="text/css" href="/RCweb/Public/Home/css/d.css" />
		<link rel="stylesheet" type="text/css" href="/RCweb/Public/Home/css/media.css" />
	</head>

	<body class="zhuti"><form>
		<div class="message">

			<div>
				<h3>欢迎联系我们！</h3>
				<textarea name="textarea" placeholder="您可以在此留言"></textarea>
			</div>
			<div>
		...
		<div class="main">
			...
			<div class="CS">
				...
				<div class="tu3 clearfix">
					<div class="tu3_1">
						<div class="tu3_1_s">
							<a href="#"><img src="/RCweb/Public/Home/img/3-1.png" alt="加载失败" /></a>
						</div>
						<div class="tu3_1_x">
							<div class="bk_1">
								<a href="#"><h2>企业文化</h2></a>
								<h3>诚信创新、传承品质、厚积薄发</h3>
							</div>
						</div>
					</div>
					<div class="tu3_2">
						<div class="tu3_2_s">
							<a href="#"><img src="/RCweb/Public/Home/img/3-2.png" alt="加载失败" /></a>
						</div>
						<div class="tu3_2_x">
							<div class="bk_1">
								<a href="#"><h2>团队精神</h2></a>
					...
					<div class="tu3_3">
						<div class="tu3_3_s">
							<a href="#"><img src="/RCweb/Public/Home/img/3-3.png" alt="加载失败" /></a>
						</div>
						<div class="tu3_3_x">
							<div class="bk_1">
								<a href="#"><h2>经营理念</h2></a>
								<h3>愿与各方朋友齐聚一堂，愿我们的服务得到您的点赞</h3>
							</div>
						</div>
					</div>
					<!--tu3 end-->
				...
				<div class="zizhi">
					...
					<div class="zzt">
						<img  src="/RCweb/Public/Home/img/3-6.png"/>
						<img  src="/RCweb/Public/Home/img/3-4.png"/>
						<img  src="/RCweb/Public/Home/img/3-5.png"/>
					</div>
		...
		<script type="text/javascript">
			$(function() {
				...
				$('#banner_tabs #6B6B6B').click(function() {
					bannerSlider.prev()
				});
