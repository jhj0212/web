		...
		<div class="main">
			...
			<div class="main_title">
				...
				<div class="main_stitle">
					<span><?php echo (date('Y-m-d',$res["time"])); ?></span>
					<span style="color: red;"><?php echo ($res['type']); ?></span>
				</div>
			</div>
			<!--main_title-->
			<!--main_con-->
		...
		<div class="footer">
			<div class="footer_main clearfix">
				<div class="footer_main_1">
					<a href="#">相关链接： </a>
					<a href="#">吉林省智城智家科技有限公司</a>
					<a href="#">吉林省欣恒科技有限公司</a>
					<a href="#">吉林省弘朗科技有限公司</a>
				</div>
			...
			<div class="banquan">
				<p>版权所有：吉林市睿诚财务管理咨询有限公司 吉ICP备17006428号</p>
			</div>
		</div>
		<!--footer end-->
		<script type="text/javascript">
