...
var uploadTools = {
    ...
    "getInitOption":function(uploadId){
        ...
        var initOption={
            "uploadId":uploadId,
            "uploadUrl":"{:U('runAddNews')}",//必须，上传地址
            ...
            "filelSavePath":" +  /Public/uploads/ + ",//文件上传地址，后台设置的根目录
    ...
    "getShowFileType":function(isImg,fileType,fileName,isImgUrl,fileCodeId){
       ...
       /* modelStr+=" <div class='progress'>";
        ...
        modelStr+="<i class='iconfont icon-trash-o'></i>";
        modelStr+="</div>";
        ...
        for(var i=0;i<fileList.length;i++){
            ...
            if(fileTypeArray=="*"||uploadTools.isInArray(fileTypeStr,fileTypeArray)){
                ...
                if(imgtest.test(fileList[i].type)){
                    ...
                    alert(window.URL.createObjectURL(fileList[i]));
    ...
    "uploadFile":function(opt){
        ...
        if(uploadUrl!="#"&&uploadUrl!=""){
            ...
            $.ajax({
                ...
                success:function(data){
                    setTimeout(function(){opt.onUpload(data123
                    )},500);
                },
                error:function(e){
...
/*
var getFileName = function (fileN) {
    var str =
}*/
